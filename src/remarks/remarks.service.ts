...
export class RemarksService {
    constructor(@InjectModel(Remark.name) private readonly remarkModel: Model<RemarkDocument>,) {}
    ...
    async update(id:string,newData:Partial<Remark>):Promise<Remark> {
        return this.remarkModel.findByIdAndUpdate(id,newData,{new:true}).exec()
    }
